...
if (process.env.THORIN_LOG_TIME === "false" || global.THORIN_LOG_TIME === 'false' || global.THORIN_LOG_TIME === false) {
  DATE_FORMAT = "";
}
module.exports = function (thorin) {
  colors.enabled = true;
  if (!global.THORIN_COLORS && (thorin.docker === true || global.THORIN_DOCKER)) {
