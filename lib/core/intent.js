...
module.exports = function init(thorin) {
  ...
  class ThorinIntent {
    ...
    hasFilter() {
      if (typeof this[rawFilter] !== 'object' || !this[rawFilter]) return false;
      return true;
    }
    ...
    client(key, val) {
      ...
      if (typeof key === 'string' && typeof val === 'undefined') {
        ...
        return (typeof this[client][key] === 'undefined' ? null : this[client][key]);
      }
      this[client][key] = val;
      return this;
    }
    ...
    filter(name, _val) {
      ...
      if (typeof name === 'string' && typeof _val === 'undefined') {
        ...
        if (typeof this[filter] === 'undefined') return null;
        return (typeof this[filter][name] === 'undefined' ? null : this[filter][name]);
      }
      if (typeof name === 'string' && typeof _val !== 'undefined') {
    ...
    meta(name, _val) {
      ...
      if (typeof name === 'string' && typeof _val === 'undefined') {
        ...
        if (typeof this[meta] === 'undefined') return null;
        return (typeof this[meta][name] === 'undefined' ? null : this[meta][name]);
      }
      if (typeof name === 'string' && typeof _val !== 'undefined') {
    ...
    * */
    ...
    destroy() {
      this[data] = null;
      this[rawInput] = null;
      if (this[rawFilter]) this[rawFilter] = null;
      if (this[filter]) this[filter] = null;
      if (this[rawMeta]) this[rawMeta] = null;
      this[input] = null;
      this[result] = null;
      this[error] = null;
    ...
    /*
     * Triggers an internal event. This should only be used by
     * other plugins or core components.
     * */
    __trigger() {
