    ...
    #runStackItem = async (item, intentObj) => {
      ...
      if (item.type === HANDLER_TYPE.MIDDLEWARE) {
        ...
        if (typeof item.condition === 'function') {
          ...
          try {
            ...
            console.log('thorin.action._runStack: use() function threw an error in middleware condition of action ' + this.name);
            console.log(e, item);
            return;
          }
      ...
      if (item.type === HANDLER_TYPE.AUTHORIZE) {
        ...
        if (typeof item.condition === 'function') {
          ...
          try {
            ...
            console.log('thorin.action._runStack: use() function threw an error in authorization condition of action ' + this.name);
            console.log(e, item);
            return;
          }
          if (shouldRun !== true) return;
      ...
      if (item.type === HANDLER_TYPE.USE) {
        return new Promise((resolve, reject) => {
          ...
          try {
            ...
            console.log('thorin.action._runStack: use() function threw an error in action ' + this.name);
            console.log(item);
      ...
      return new Promise((resolve, reject) => {
        ...
        try {
          ...
          console.log('thorin.action._runCustomType: use() function threw an error in action ' + this.name);
          console.log(item);
          doneWrap(app.error(e));
        }
      });
